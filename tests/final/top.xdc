...
set_false_path -from [get_ports SW[10]]
set_false_path -from [get_ports SW[11]]
set_false_path -from [get_ports SW[12]]
set_false_path -from [get_ports SW[13]]
set_false_path -from [get_ports SW[14]]
set_false_path -from [get_ports SW[15]]
...
set_false_path -to [get_ports LED[6]]
set_false_path -to [get_ports LED[7]]
set_false_path -to [get_ports LED[8]]
set_false_path -to [get_ports LED[9]]
set_false_path -to [get_ports LED[10]]
set_false_path -to [get_ports LED[11]]
set_false_path -to [get_ports LED[12]]
set_false_path -to [get_ports LED[13]]
set_false_path -to [get_ports LED[14]]
set_false_path -to [get_ports LED[15]]

set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { RGB0[2] }]; #IO_L5P_T0_D06_14 Sch=led16_b
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { RGB0[1] }]; #IO_L10P_T1_D14_14 Sch=led16_g
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { RGB0[0] }]; #IO_L11P_T1_SRCC_14 Sch=led16_r
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { RGB1[2] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led17_b
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { RGB1[1] }]; #IO_0_14 Sch=led17_g
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { RGB1[0] }]; #IO_L11N_T1_SRCC_14 Sch=led17_r
set_false_path -to [get_ports RGB0[0]]
set_false_path -to [get_ports RGB0[1]]
set_false_path -to [get_ports RGB0[2]]
set_false_path -to [get_ports RGB1[0]]
set_false_path -to [get_ports RGB1[1]]
set_false_path -to [get_ports RGB1[2]]
...
set_false_path -to [get_ports SEG[0]]
set_false_path -to [get_ports SEG[1]]
set_false_path -to [get_ports SEG[2]]
set_false_path -to [get_ports SEG[3]]
set_false_path -to [get_ports SEG[4]]
set_false_path -to [get_ports SEG[5]]
set_false_path -to [get_ports SEG[6]]
set_false_path -to [get_ports SEG[7]]
...
set_false_path -to [get_ports AN[0]]
set_false_path -to [get_ports AN[1]]
set_false_path -to [get_ports AN[2]]
set_false_path -to [get_ports AN[3]]
